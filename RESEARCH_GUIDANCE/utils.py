...
def send_research_guidance_status_email(
    email,
    username,
    scholar_name,
    status,
    ...
    <html>
        <body>
            ...
            <p>Your research guidance request for:</p>

            <p><strong>{scholar_name}</strong></p>
    ...
    email_data = sib_api_v3_sdk.SendSmtpEmail(
        ...
        to=[{"email": email}],
        subject=f"Research Guidance Request {status.title()}",
